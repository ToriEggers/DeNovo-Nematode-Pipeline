...
1) For an introduction to the hpc and a linux environment: [Getting Started](https://github.com/ToriEggers/DeNovo-Nematode-Pipeline/blob/main/Getting_Started.md)

2) Pipeline: [DeNovo Nematode Pipeline](https://github.com/ToriEggers/DeNovo-Nematode-Pipeline/blob/main/DeNovo-Nematode-Pipeline.md) 
